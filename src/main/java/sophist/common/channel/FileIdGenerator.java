	...
	public Serializable generate(SharedSessionContractImplementor session, Object object) throws HibernateException {
		...
		try {
			...
			ResultSet rs = statement
					.executeQuery("select case when char_length(cast(file_cd as varchar)) =1 then '00000000' || file_cd"
							...
							+ " when char_length(cast(file_cd as varchar)) =8 then '0' || file_cd" + " end "
